# -*- coding: utf-8 -*-
"""
Created on Mon Jan 25 14:12:14 2021
...
def load_model():
    global df
    df = pd.read_csv('list_of_etsy_reviews.csv')
    ...
    '''positive_reviews = df_balanced_reviews[df_balanced_reviews['reviewType'] == 'Positive'].shape[0]
    negative_reviews = df_balanced_reviews[df_balanced_reviews['reviewType'] == 'Negative'].shape[0]
...
def main():
    ...
    #once execution comes to a halt
    projectName = None
    app = None
